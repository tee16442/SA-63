...
func (e CustomerEdges) Checkout2OrErr() ([]*Checkout, error) {
	if e.loadedTypes[0] {
...
// QueryCheckout2 queries the checkout2 edge of the Customer.
func (c *Customer) QueryCheckout2() *CheckoutQuery {
	return (&CustomerClient{config: c.config}).QueryCheckout2(c)
}
