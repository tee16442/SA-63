...
// HasCheckout2 applies the HasEdge predicate on the "checkout2" edge.
func HasCheckout2() predicate.Customer {
	return predicate.Customer(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
			sqlgraph.To(Checkout2Table, FieldID),
			sqlgraph.Edge(sqlgraph.O2M, false, Checkout2Table, Checkout2Column),
		)
		sqlgraph.HasNeighbors(s, step)
	})
}

// HasCheckout2With applies the HasEdge predicate on the "checkout2" edge with a given conditions (other predicates).
func HasCheckout2With(preds ...predicate.Checkout) predicate.Customer {
	return predicate.Customer(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
			sqlgraph.To(Checkout2InverseTable, FieldID),
			sqlgraph.Edge(sqlgraph.O2M, false, Checkout2Table, Checkout2Column),
		)
