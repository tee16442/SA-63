...
// The AdultFunc type is an adapter to allow the use of ordinary
// function as Adult mutator.
type AdultFunc func(context.Context, *ent.AdultMutation) (ent.Value, error)

// Mutate calls f(ctx, m).
func (f AdultFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	mv, ok := m.(*ent.AdultMutation)
	if !ok {
		return nil, fmt.Errorf("unexpected mutation type %T. expect *ent.AdultMutation", m)
	}
	return f(ctx, mv)
}
...
// The KidFunc type is an adapter to allow the use of ordinary
// function as Kid mutator.
type KidFunc func(context.Context, *ent.KidMutation) (ent.Value, error)

// Mutate calls f(ctx, m).
func (f KidFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	mv, ok := m.(*ent.KidMutation)
	if !ok {
		return nil, fmt.Errorf("unexpected mutation type %T. expect *ent.KidMutation", m)
	}
	return f(ctx, mv)
}
...
// The RoomamountFunc type is an adapter to allow the use of ordinary
// function as Roomamount mutator.
type RoomamountFunc func(context.Context, *ent.RoomamountMutation) (ent.Value, error)

// Mutate calls f(ctx, m).
func (f RoomamountFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	mv, ok := m.(*ent.RoomamountMutation)
	if !ok {
		return nil, fmt.Errorf("unexpected mutation type %T. expect *ent.RoomamountMutation", m)
	}
	return f(ctx, mv)
}
